...
public class Scheme17 extends BaseSchemeUniformOnly {

    //full
    static List<Formula> formulas = new ArrayList<Formula>() {{
        add(new Formula(930, "Ф1(+0,25) – 12 – 2х", BetType.F1plus025, BetType.P12, BetType.P2X));
        add(new Formula(931, "Ф2(+0,25) – 12 – 1х", BetType.F2plus025, BetType.P12, BetType.P1X));
    }};
    ...
    protected BranchResult calculateUniform(List<EventSum> bets, Formula f, Double totalSum) {
        ...
        Double X1 = 1 / K1 + 1 / K2 + 1 / (K1 * K2) + 2 / K3;
        Double X2 = (K1 + 1) / (2 * K2);
        Double X3 = K1 / K3;
